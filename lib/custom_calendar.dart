...
class CustomCalendarDatePicker extends StatefulWidget {
  ...
  CustomCalendarDatePicker({
    ...
    this.currentYearColor = Colors.white,
...
class _MonthPicker extends StatefulWidget {
  ...
  _MonthPicker({
    ...
    this.selectableDayPredicate,
    // custom stuff:
    required this.monthControlIconRight,
    required this.monthControlIconLeft,
    required this.controlColor,
    ...
    required this.weekdayAxisColor,
  ...
  /// icon for control the month switch
  final Widget monthControlIconRight;
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                const Spacer(),
                IconButton(
                  icon: widget.monthControlIconLeft,
                  color: widget.controlColor,
                ...
                IconButton(
                  icon: widget.monthControlIconRight,
                  color: widget.controlColor,
  ...
  Widget build(BuildContext context) {
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        Color dayColor = widget.enabledDayColor;
        if (isSelectedDay) {
          // The selected day gets a circle background highlight, and a
          // contrasting text color.
          dayColor = widget.selectedDayColor;
          decoration = BoxDecoration(
            color: widget.selectedDayBackground,
            shape: BoxShape.circle,
          );
        } else if (isDisabled) {
          dayColor = widget.disabledDayColor;
        } else if (isToday) {
          // The current day gets a different text color and a circle stroke
          // border.
          dayColor = widget.todayColor;
          decoration = BoxDecoration(
            border: Border.all(color: widget.todayColor),
            shape: BoxShape.circle,
          );
        }
        ...
        if (isDisabled) {
          ...
          dayWidget = InkResponse(
            ...
            splashColor: widget.selectedDayBackground.withOpacity(0.38),
            child: Semantics(
...
class YearPicker extends StatefulWidget {
  ...
  YearPicker({
    ...
    required this.enabledYearColor,
    required this.disabledYearColor,
    required this.selectedYearColor,
    required this.selectedYearBackground,
    required this.currentYearColor,
  })  : assert(!firstDate.isAfter(lastDate)),
        currentDate = DateUtils.dateOnly(currentDate ?? DateTime.now()),
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    if (isSelected) {
      textColor = widget.selectedYearColor;
    } else if (isDisabled) {
      textColor = widget.disabledYearColor;
    } else if (isCurrentYear) {
      textColor = widget.currentYearColor;
    } else {
      textColor = widget.enabledYearColor;
    }
    ...
    if (isSelected) {
      decoration = BoxDecoration(
        color: widget.selectedYearBackground,
        borderRadius: BorderRadius.circular(decorationHeight / 2),
      );
    } else if (isCurrentYear && !isDisabled) {
      decoration = BoxDecoration(
        border: Border.all(
          color: widget.currentYearColor,
        ),
        borderRadius: BorderRadius.circular(decorationHeight / 2),
      );
    }
